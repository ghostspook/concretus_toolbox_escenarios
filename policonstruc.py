...
ambiente = deep.cargar_escenario(ambiente, 'input/POLICONSTRUC_NOVIEMBRE_2021.xlsx')
deep.validar_escenario(ambiente, 'POLICONSTRUC_NOVIEMBRE_2021', imprimir=True)
...
# ambiente.to_excel("output/POLICONSTRUC_NOVIEMBRE_2021.xlsx")
