...
ambiente = deep.cargar_escenario(ambiente, 'input/INGEOBRAS_NOVIEMBRE_2021.xlsx')
deep.validar_escenario(ambiente, 'INGEOBRAS_NOVIEMBRE_2021', imprimir=True)
...
# ambiente.to_excel("output/INGEOBRAS_NOVIEMBRE_2021.xlsx")
